...
export default {
    ...
    dashboard: {
        ...
        removeCurrentCountry: 'Usuń bieżący kraj',
        removeCurrentCountryConfirmationTitle: 'Czy na pewno chcesz usunąć wsparcie dla bieżącego kraju?',
        removeCurrentCountryConfirmationContent: 'Zostaniesz tylko Ty i Twoi przyjaciele.',
