...
export default {
    ...
    dashboard: {
        ...
        removeCurrentCountry: 'Remove current country',
        removeCurrentCountryConfirmationTitle: 'Are you sure you want to remove support for the current country?',
        removeCurrentCountryConfirmationContent: 'Only you and your friends will be left.',
